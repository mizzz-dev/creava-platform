      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {items.map((item, index) => (
          <Link
            ...
            className={`group flex h-full flex-col rounded-3xl border p-5 transition duration-300 hover:-translate-y-0.5 hover:shadow-md ${TONE_CLASS[item.tone ?? 'default']} ${index === 0 ? 'lg:col-span-2' : ''}`}
          >
