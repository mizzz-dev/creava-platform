...
import { confirmContact, submitContact, type ContactPayload, FormSubmissionError } from '@/modules/contact/lib/submit'
...
const DRAFT_KEY = 'contact-form-draft-v2'
...
export function useContactForm() {
  ...
  async function confirm() {
    await confirmContact({ ...fields, locale: i18n.language, sourcePage: '/contact?tab=contact' })
  }
